...
pub struct PostApiVersionLinodeInstancesLinodeIdCloneResponse {
    #[cfg_attr(feature = "cli", arg(id = "alerts", long = "alerts"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponseAlerts>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alerts: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponseAlerts,
    >,
    #[cfg_attr(feature = "cli", arg(id = "backups", long = "backups"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponseBackups>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub backups: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponseBackups,
    >,
    ...
    pub hypervisor: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponseHypervisorEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponsePlacementGroup>
        )
    )]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponsePlacementGroup>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub placement_group: crate::core::patch::Patch<
        crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponsePlacementGroup,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponseSpecs>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub specs: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponseSpecs,
    >,
    #[cfg_attr(feature = "cli", arg(id = "status", long = "status"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdCloneResponseStatusEnum,
    >,
