...
pub struct PutApiVersionLinodeInstancesLinodeIdBodyBackups {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionLinodeInstancesLinodeIdBodyBackupsSchedule>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub schedule: Option<
        crate::models::PutApiVersionLinodeInstancesLinodeIdBodyBackupsSchedule,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
