...
pub struct PostApiVersionAccountUsersBody {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionAccountUsersBodyLastLogin>
        )
    )]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::PostApiVersionAccountUsersBodyLastLogin>,
    ...
    pub last_login: crate::core::patch::Patch<
        crate::models::PostApiVersionAccountUsersBodyLastLogin,
    >,
