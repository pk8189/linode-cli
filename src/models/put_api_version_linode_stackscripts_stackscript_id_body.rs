...
pub struct PutApiVersionLinodeStackscriptsStackscriptIdBody {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionLinodeStackscriptsStackscriptIdBodyUserDefinedFieldsItem>
        )
    )]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub user_defined_fields: Option<
        Vec<
            crate::models::PutApiVersionLinodeStackscriptsStackscriptIdBodyUserDefinedFieldsItem,
        >,
    >,
