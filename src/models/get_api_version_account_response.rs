...
pub struct GetApiVersionAccountResponse {
    #[cfg_attr(
        feature = "cli",
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionAccountResponseActivePromotionsItem>
        )
    )]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub active_promotions: Option<
        Vec<crate::models::GetApiVersionAccountResponseActivePromotionsItem>,
    >,
    ...
    pub billing_source: Option<
        crate::models::GetApiVersionAccountResponseBillingSourceEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionAccountResponseCreditCard>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub credit_card: Option<crate::models::GetApiVersionAccountResponseCreditCard>,
