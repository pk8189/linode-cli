...
pub struct PostApiVersionLinodeInstancesResponseBackups {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesResponseBackupsSchedule>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub schedule: Option<
        crate::models::PostApiVersionLinodeInstancesResponseBackupsSchedule,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
