...
pub struct GetApiVersionAccountServiceTransfersResponseDataItem {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionAccountServiceTransfersResponseDataItemEntities>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub entities: Option<
        crate::models::GetApiVersionAccountServiceTransfersResponseDataItemEntities,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionAccountServiceTransfersResponseDataItemStatusEnum,
    >,
