...
pub struct GetApiVersionSupportTicketsResponseDataItem {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionSupportTicketsResponseDataItemEntity>
        )
    )]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::GetApiVersionSupportTicketsResponseDataItemEntity>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub entity: crate::core::patch::Patch<
        crate::models::GetApiVersionSupportTicketsResponseDataItemEntity,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionSupportTicketsResponseDataItemStatusEnum,
    >,
