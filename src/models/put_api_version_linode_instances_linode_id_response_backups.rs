...
pub struct PutApiVersionLinodeInstancesLinodeIdResponseBackups {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionLinodeInstancesLinodeIdResponseBackupsSchedule>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub schedule: Option<
        crate::models::PutApiVersionLinodeInstancesLinodeIdResponseBackupsSchedule,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
