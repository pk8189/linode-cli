...
pub struct GetApiVersionDomainsDomainIdRecordsRecordIdResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::GetApiVersionDomainsDomainIdRecordsRecordIdResponseTagEnum>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub tag: crate::core::patch::Patch<
        crate::models::GetApiVersionDomainsDomainIdRecordsRecordIdResponseTagEnum,
    >,
    ...
    pub type_field: Option<
        crate::models::GetApiVersionDomainsDomainIdRecordsRecordIdResponseTypeEnum,
    >,
