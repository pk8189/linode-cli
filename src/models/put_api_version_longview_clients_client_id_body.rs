...
pub struct PutApiVersionLongviewClientsClientIdBody {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionLongviewClientsClientIdBodyApps>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub apps: Option<crate::models::PutApiVersionLongviewClientsClientIdBodyApps>,
