...
pub struct PostApiVersionImagesUploadResponseImage {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionImagesUploadResponseImageRegionsItem>
        )
    )]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub regions: Option<
        Vec<crate::models::PostApiVersionImagesUploadResponseImageRegionsItem>,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::PostApiVersionImagesUploadResponseImageStatusEnum>,
    ...
    pub type_field: Option<
        crate::models::PostApiVersionImagesUploadResponseImageTypeEnum,
    >,
