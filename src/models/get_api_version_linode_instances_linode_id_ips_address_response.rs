...
pub struct GetApiVersionLinodeInstancesLinodeIdIpsAddressResponse {
    ...
    pub type_field: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdIpsAddressResponseTypeEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "vpc-nat-1-1", long = "vpc-nat-1-1"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeInstancesLinodeIdIpsAddressResponseVpcNat11>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub vpc_nat_1_1: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdIpsAddressResponseVpcNat11,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
