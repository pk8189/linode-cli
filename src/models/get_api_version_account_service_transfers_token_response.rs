...
pub struct GetApiVersionAccountServiceTransfersTokenResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionAccountServiceTransfersTokenResponseEntities>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub entities: Option<
        crate::models::GetApiVersionAccountServiceTransfersTokenResponseEntities,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionAccountServiceTransfersTokenResponseStatusEnum,
    >,
