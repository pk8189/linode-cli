...
pub struct GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesResponseDataItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mode: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesResponseDataItemModeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesResponseDataItemStatusEnum,
    >,
