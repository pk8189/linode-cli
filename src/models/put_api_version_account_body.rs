...
pub struct PutApiVersionAccountBody {
    #[cfg_attr(
        feature = "cli",
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionAccountBodyActivePromotionsItem>
        )
    )]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub active_promotions: Option<
        Vec<crate::models::PutApiVersionAccountBodyActivePromotionsItem>,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_source: Option<crate::models::PutApiVersionAccountBodyBillingSourceEnum>,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionAccountBodyCreditCard>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub credit_card: Option<crate::models::PutApiVersionAccountBodyCreditCard>,
