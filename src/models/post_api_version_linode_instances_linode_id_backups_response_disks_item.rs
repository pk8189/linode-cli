...
pub struct PostApiVersionLinodeInstancesLinodeIdBackupsResponseDisksItem {
    #[cfg_attr(feature = "cli", arg(id = "filesystem", long = "filesystem"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub filesystem: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdBackupsResponseDisksItemFilesystemEnum,
    >,
