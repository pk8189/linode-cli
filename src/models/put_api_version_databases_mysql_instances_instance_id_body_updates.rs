...
pub struct PutApiVersionDatabasesMysqlInstancesInstanceIdBodyUpdates {
    ...
    pub frequency: Option<
        crate::models::PutApiVersionDatabasesMysqlInstancesInstanceIdBodyUpdatesFrequencyEnum,
    >,
