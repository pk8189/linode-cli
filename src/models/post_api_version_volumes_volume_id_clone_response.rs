...
pub struct PostApiVersionVolumesVolumeIdCloneResponse {
    ...
    pub encryption: Option<
        crate::models::PostApiVersionVolumesVolumeIdCloneResponseEncryptionEnum,
    >,
    ...
    pub hardware_type: Option<
        crate::models::PostApiVersionVolumesVolumeIdCloneResponseHardwareTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionVolumesVolumeIdCloneResponseStatusEnum,
    >,
