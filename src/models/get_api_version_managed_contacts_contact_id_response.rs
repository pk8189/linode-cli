...
pub struct GetApiVersionManagedContactsContactIdResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionManagedContactsContactIdResponsePhone>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub phone: Option<crate::models::GetApiVersionManagedContactsContactIdResponsePhone>,
