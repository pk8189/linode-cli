...
pub struct PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesNodeIdResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mode: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesNodeIdResponseModeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesNodeIdResponseStatusEnum,
    >,
