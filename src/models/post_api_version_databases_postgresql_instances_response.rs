...
pub struct PostApiVersionDatabasesPostgresqlInstancesResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionDatabasesPostgresqlInstancesResponseHosts>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub hosts: Option<
        crate::models::PostApiVersionDatabasesPostgresqlInstancesResponseHosts,
    >,
    ...
    pub replication_commit_type: Option<
        crate::models::PostApiVersionDatabasesPostgresqlInstancesResponseReplicationCommitTypeEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "replication-type", long = "replication-type"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub replication_type: Option<
        crate::models::PostApiVersionDatabasesPostgresqlInstancesResponseReplicationTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionDatabasesPostgresqlInstancesResponseStatusEnum,
    >,
    #[cfg_attr(
        feature = "cli",
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionDatabasesPostgresqlInstancesResponseUpdates>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub updates: Option<
        crate::models::PostApiVersionDatabasesPostgresqlInstancesResponseUpdates,
    >,
    #[cfg_attr(
        feature = "cli",
