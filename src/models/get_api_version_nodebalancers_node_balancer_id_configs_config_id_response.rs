...
pub struct GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponse {
    #[cfg_attr(feature = "cli", arg(id = "algorithm", long = "algorithm"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseAlgorithmEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "check", long = "check"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub check: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseCheckEnum,
    >,
    ...
    pub cipher_suite: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseCipherSuiteEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseNodesStatus>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nodes_status: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseNodesStatus,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub protocol: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseProtocolEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "proxy-protocol", long = "proxy-protocol"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub proxy_protocol: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseProxyProtocolEnum,
    >,
    ...
    pub stickiness: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseStickinessEnum,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
