...
pub struct GetApiVersionNodebalancersNodeBalancerIdConfigsResponseDataItem {
    #[cfg_attr(feature = "cli", arg(id = "algorithm", long = "algorithm"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsResponseDataItemAlgorithmEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "check", long = "check"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub check: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsResponseDataItemCheckEnum,
    >,
    ...
    pub cipher_suite: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsResponseDataItemCipherSuiteEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsResponseDataItemNodesStatus>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nodes_status: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsResponseDataItemNodesStatus,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub protocol: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsResponseDataItemProtocolEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "proxy-protocol", long = "proxy-protocol"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub proxy_protocol: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsResponseDataItemProxyProtocolEnum,
    >,
    ...
    pub stickiness: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdConfigsResponseDataItemStickinessEnum,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
