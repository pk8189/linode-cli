...
pub struct GetApiVersionTagsTagLabelResponseDataItemDataObj1 {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj1StatusEnum,
    >,
    ...
    pub type_field: Option<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj1TypeEnum,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
