...
pub struct GetApiVersionLinodeInstancesLinodeIdResponse {
    #[cfg_attr(feature = "cli", arg(id = "alerts", long = "alerts"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeInstancesLinodeIdResponseAlerts>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alerts: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdResponseAlerts,
    >,
    #[cfg_attr(feature = "cli", arg(id = "backups", long = "backups"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeInstancesLinodeIdResponseBackups>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub backups: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdResponseBackups,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::GetApiVersionLinodeInstancesLinodeIdResponseDiskEncryptionEnum>,
    ...
    pub disk_encryption: crate::core::patch::Patch<
        crate::models::GetApiVersionLinodeInstancesLinodeIdResponseDiskEncryptionEnum,
    >,
    ...
    pub hypervisor: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdResponseHypervisorEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeInstancesLinodeIdResponsePlacementGroup>
        )
    )]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::GetApiVersionLinodeInstancesLinodeIdResponsePlacementGroup>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub placement_group: crate::core::patch::Patch<
        crate::models::GetApiVersionLinodeInstancesLinodeIdResponsePlacementGroup,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeInstancesLinodeIdResponseSpecs>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub specs: Option<crate::models::GetApiVersionLinodeInstancesLinodeIdResponseSpecs>,
    #[cfg_attr(feature = "cli", arg(id = "status", long = "status"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdResponseStatusEnum,
    >,
