...
pub struct PostApiVersionLinodeInstancesLinodeIdConfigsBody {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdConfigsBodyDevices>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub devices: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdConfigsBodyDevices,
    >,
    #[cfg_attr(feature = "cli", arg(id = "helpers", long = "helpers"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdConfigsBodyHelpers>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub helpers: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdConfigsBodyHelpers,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdConfigsBodyInterfacesItem>
        )
    )]
    ...
    pub interfaces: Option<
        Vec<
            crate::models::PostApiVersionLinodeInstancesLinodeIdConfigsBodyInterfacesItem,
        >,
    >,
    ...
    pub run_level: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdConfigsBodyRunLevelEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "virt-mode", long = "virt-mode"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub virt_mode: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdConfigsBodyVirtModeEnum,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
