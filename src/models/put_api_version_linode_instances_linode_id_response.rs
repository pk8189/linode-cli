...
pub struct PutApiVersionLinodeInstancesLinodeIdResponse {
    #[cfg_attr(feature = "cli", arg(id = "alerts", long = "alerts"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionLinodeInstancesLinodeIdResponseAlerts>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alerts: Option<
        crate::models::PutApiVersionLinodeInstancesLinodeIdResponseAlerts,
    >,
    #[cfg_attr(feature = "cli", arg(id = "backups", long = "backups"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionLinodeInstancesLinodeIdResponseBackups>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub backups: Option<
        crate::models::PutApiVersionLinodeInstancesLinodeIdResponseBackups,
    >,
    ...
    pub hypervisor: Option<
        crate::models::PutApiVersionLinodeInstancesLinodeIdResponseHypervisorEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionLinodeInstancesLinodeIdResponsePlacementGroup>
        )
    )]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::PutApiVersionLinodeInstancesLinodeIdResponsePlacementGroup>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub placement_group: crate::core::patch::Patch<
        crate::models::PutApiVersionLinodeInstancesLinodeIdResponsePlacementGroup,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionLinodeInstancesLinodeIdResponseSpecs>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub specs: Option<crate::models::PutApiVersionLinodeInstancesLinodeIdResponseSpecs>,
    #[cfg_attr(feature = "cli", arg(id = "status", long = "status"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PutApiVersionLinodeInstancesLinodeIdResponseStatusEnum,
    >,
