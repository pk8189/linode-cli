...
pub struct GetApiVersionAccountEventsEventIdResponse {
    #[cfg_attr(feature = "cli", arg(id = "action", long = "action"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub action: Option<
        crate::models::GetApiVersionAccountEventsEventIdResponseActionEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionAccountEventsEventIdResponseEntity>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub entity: Option<crate::models::GetApiVersionAccountEventsEventIdResponseEntity>,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionAccountEventsEventIdResponseSecondaryEntity>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub secondary_entity: Option<
        crate::models::GetApiVersionAccountEventsEventIdResponseSecondaryEntity,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionAccountEventsEventIdResponseStatusEnum,
    >,
