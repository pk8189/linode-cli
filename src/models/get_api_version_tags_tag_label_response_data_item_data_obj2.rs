...
pub struct GetApiVersionTagsTagLabelResponseDataItemDataObj2 {
    ...
    pub encryption: Option<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj2EncryptionEnum,
    >,
    ...
    pub hardware_type: Option<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj2HardwareTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj2StatusEnum,
    >,
