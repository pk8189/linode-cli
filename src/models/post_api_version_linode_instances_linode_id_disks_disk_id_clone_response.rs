...
pub struct PostApiVersionLinodeInstancesLinodeIdDisksDiskIdCloneResponse {
    ...
    pub filesystem: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdDisksDiskIdCloneResponseFilesystemEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdDisksDiskIdCloneResponseStatusEnum,
    >,
