...
pub struct PutApiVersionLinodeInstancesLinodeIdIpsAddressResponse {
    ...
    pub type_field: Option<
        crate::models::PutApiVersionLinodeInstancesLinodeIdIpsAddressResponseTypeEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "vpc-nat-1-1", long = "vpc-nat-1-1"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionLinodeInstancesLinodeIdIpsAddressResponseVpcNat11>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub vpc_nat_1_1: Option<
        crate::models::PutApiVersionLinodeInstancesLinodeIdIpsAddressResponseVpcNat11,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
