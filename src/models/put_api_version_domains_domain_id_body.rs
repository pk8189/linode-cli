...
pub struct PutApiVersionDomainsDomainIdBody {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::PutApiVersionDomainsDomainIdBodyStatusEnum>,
    ...
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_field: Option<crate::models::PutApiVersionDomainsDomainIdBodyTypeEnum>,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
        arg(
