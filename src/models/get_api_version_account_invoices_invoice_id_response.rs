...
pub struct GetApiVersionAccountInvoicesInvoiceIdResponse {
    #[cfg_attr(feature = "cli", arg(id = "billing-source", long = "billing-source"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_source: Option<
        crate::models::GetApiVersionAccountInvoicesInvoiceIdResponseBillingSourceEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionAccountInvoicesInvoiceIdResponseTaxSummaryItem>
        )
    )]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tax_summary: Option<
        Vec<crate::models::GetApiVersionAccountInvoicesInvoiceIdResponseTaxSummaryItem>,
    >,
