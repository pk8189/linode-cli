...
pub struct PostApiVersionManagedServicesResponse {
    ...
    pub service_type: Option<
        crate::models::PostApiVersionManagedServicesResponseServiceTypeEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "status", long = "status"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::PostApiVersionManagedServicesResponseStatusEnum>,
