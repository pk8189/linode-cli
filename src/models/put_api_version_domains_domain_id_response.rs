...
pub struct PutApiVersionDomainsDomainIdResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::PutApiVersionDomainsDomainIdResponseStatusEnum>,
    ...
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_field: Option<crate::models::PutApiVersionDomainsDomainIdResponseTypeEnum>,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
        arg(
