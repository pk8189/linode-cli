...
pub struct GetApiVersionDatabasesPostgresqlInstancesInstanceIdResponseUpdates {
    ...
    pub frequency: Option<
        crate::models::GetApiVersionDatabasesPostgresqlInstancesInstanceIdResponseUpdatesFrequencyEnum,
    >,
