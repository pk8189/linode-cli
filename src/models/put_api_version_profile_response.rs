...
pub struct PutApiVersionProfileResponse {
    #[cfg_attr(
        feature = "cli",
    ...
    pub authentication_type: Option<
        crate::models::PutApiVersionProfileResponseAuthenticationTypeEnum,
    >,
    ...
    pub lish_auth_method: Option<
        crate::models::PutApiVersionProfileResponseLishAuthMethodEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "referrals", long = "referrals"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionProfileResponseReferrals>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub referrals: Option<crate::models::PutApiVersionProfileResponseReferrals>,
