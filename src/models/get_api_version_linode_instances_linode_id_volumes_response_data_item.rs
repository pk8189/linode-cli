...
pub struct GetApiVersionLinodeInstancesLinodeIdVolumesResponseDataItem {
    ...
    pub encryption: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdVolumesResponseDataItemEncryptionEnum,
    >,
    ...
    pub hardware_type: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdVolumesResponseDataItemHardwareTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdVolumesResponseDataItemStatusEnum,
    >,
