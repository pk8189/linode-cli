...
pub struct GetApiVersionLinodeInstancesLinodeIdDisksResponseDataItem {
    ...
    pub filesystem: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdDisksResponseDataItemFilesystemEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdDisksResponseDataItemStatusEnum,
    >,
