...
pub struct PostApiVersionLinodeInstancesLinodeIdRebuildResponse {
    #[cfg_attr(feature = "cli", arg(id = "alerts", long = "alerts"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponseAlerts>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alerts: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponseAlerts,
    >,
    #[cfg_attr(feature = "cli", arg(id = "backups", long = "backups"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponseBackups>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub backups: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponseBackups,
    >,
    ...
    pub hypervisor: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponseHypervisorEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponsePlacementGroup>
        )
    )]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponsePlacementGroup>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub placement_group: crate::core::patch::Patch<
        crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponsePlacementGroup,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponseSpecs>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub specs: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponseSpecs,
    >,
    #[cfg_attr(feature = "cli", arg(id = "status", long = "status"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionLinodeInstancesLinodeIdRebuildResponseStatusEnum,
    >,
