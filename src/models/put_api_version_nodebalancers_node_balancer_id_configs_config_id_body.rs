...
pub struct PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdBody {
    #[cfg_attr(feature = "cli", arg(id = "algorithm", long = "algorithm"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdBodyAlgorithmEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "check", long = "check"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub check: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdBodyCheckEnum,
    >,
    ...
    pub cipher_suite: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdBodyCipherSuiteEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdBodyNodesStatus>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nodes_status: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdBodyNodesStatus,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub protocol: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdBodyProtocolEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "proxy-protocol", long = "proxy-protocol"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub proxy_protocol: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdBodyProxyProtocolEnum,
    >,
    ...
    pub stickiness: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdBodyStickinessEnum,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
