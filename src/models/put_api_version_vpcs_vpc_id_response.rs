...
pub struct PutApiVersionVpcsVpcIdResponse {
    ...
    #[cfg_attr(feature = "cli", arg(id = "subnets", long = "subnets"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionVpcsVpcIdResponseSubnetsItem>
        )
    )]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subnets: Option<Vec<crate::models::PutApiVersionVpcsVpcIdResponseSubnetsItem>>,
    ...
    pub updated: crate::core::patch::Patch<String>,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
        arg(
