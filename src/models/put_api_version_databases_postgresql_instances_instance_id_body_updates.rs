...
pub struct PutApiVersionDatabasesPostgresqlInstancesInstanceIdBodyUpdates {
    ...
    pub frequency: Option<
        crate::models::PutApiVersionDatabasesPostgresqlInstancesInstanceIdBodyUpdatesFrequencyEnum,
    >,
