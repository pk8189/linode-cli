...
pub struct PutApiVersionLinodeInstancesLinodeIdDisksDiskIdResponse {
    ...
    pub filesystem: Option<
        crate::models::PutApiVersionLinodeInstancesLinodeIdDisksDiskIdResponseFilesystemEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PutApiVersionLinodeInstancesLinodeIdDisksDiskIdResponseStatusEnum,
    >,
