...
pub struct PostApiVersionPlacementGroupsBody {
    ...
    pub placement_group_policy: Option<
        crate::models::PostApiVersionPlacementGroupsBodyPlacementGroupPolicyEnum,
    >,
    #[cfg_attr(
        feature = "cli",
    ...
    pub placement_group_type: Option<
        crate::models::PostApiVersionPlacementGroupsBodyPlacementGroupTypeEnum,
    >,
