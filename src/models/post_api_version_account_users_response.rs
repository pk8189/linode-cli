...
pub struct PostApiVersionAccountUsersResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionAccountUsersResponseLastLogin>
        )
    )]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::PostApiVersionAccountUsersResponseLastLogin>,
    ...
    pub last_login: crate::core::patch::Patch<
        crate::models::PostApiVersionAccountUsersResponseLastLogin,
    >,
