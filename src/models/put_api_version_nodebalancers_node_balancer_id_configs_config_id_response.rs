...
pub struct PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponse {
    #[cfg_attr(feature = "cli", arg(id = "algorithm", long = "algorithm"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseAlgorithmEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "check", long = "check"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub check: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseCheckEnum,
    >,
    ...
    pub cipher_suite: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseCipherSuiteEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseNodesStatus>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nodes_status: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseNodesStatus,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub protocol: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseProtocolEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "proxy-protocol", long = "proxy-protocol"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub proxy_protocol: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseProxyProtocolEnum,
    >,
    ...
    pub stickiness: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdResponseStickinessEnum,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
