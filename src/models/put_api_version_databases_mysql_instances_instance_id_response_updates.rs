...
pub struct PutApiVersionDatabasesMysqlInstancesInstanceIdResponseUpdates {
    ...
    pub frequency: Option<
        crate::models::PutApiVersionDatabasesMysqlInstancesInstanceIdResponseUpdatesFrequencyEnum,
    >,
