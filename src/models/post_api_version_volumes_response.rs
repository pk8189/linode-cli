...
pub struct PostApiVersionVolumesResponse {
    #[cfg_attr(feature = "cli", arg(id = "created", long = "created"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub created: Option<String>,
    #[cfg_attr(feature = "cli", arg(id = "encryption", long = "encryption"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub encryption: Option<crate::models::PostApiVersionVolumesResponseEncryptionEnum>,
    ...
    pub hardware_type: Option<
        crate::models::PostApiVersionVolumesResponseHardwareTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::PostApiVersionVolumesResponseStatusEnum>,
