...
pub struct GetApiVersionNodebalancersNodeBalancerIdResponse {
    #[cfg_attr(
        feature = "cli",
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionNodebalancersNodeBalancerIdResponseTransfer>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub transfer: Option<
        crate::models::GetApiVersionNodebalancersNodeBalancerIdResponseTransfer,
    >,
