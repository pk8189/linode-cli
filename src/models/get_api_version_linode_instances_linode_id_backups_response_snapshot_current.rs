...
pub struct GetApiVersionLinodeInstancesLinodeIdBackupsResponseSnapshotCurrent {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeInstancesLinodeIdBackupsResponseSnapshotCurrentDisksItem>
        )
    )]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub disks: Option<
        Vec<
            crate::models::GetApiVersionLinodeInstancesLinodeIdBackupsResponseSnapshotCurrentDisksItem,
        >,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdBackupsResponseSnapshotCurrentStatusEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "type-field", long = "type-field"))]
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_field: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdBackupsResponseSnapshotCurrentTypeEnum,
    >,
