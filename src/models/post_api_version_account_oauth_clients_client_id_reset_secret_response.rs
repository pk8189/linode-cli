...
pub struct PostApiVersionAccountOauthClientsClientIdResetSecretResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionAccountOauthClientsClientIdResetSecretResponseStatusEnum,
    >,
