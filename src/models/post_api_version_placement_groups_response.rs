...
pub struct PostApiVersionPlacementGroupsResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionPlacementGroupsResponseMembersItem>
        )
    )]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub members: Option<
        Vec<crate::models::PostApiVersionPlacementGroupsResponseMembersItem>,
    >,
    #[cfg_attr(
        feature = "cli",
    ...
    pub placement_group_policy: Option<
        crate::models::PostApiVersionPlacementGroupsResponsePlacementGroupPolicyEnum,
    >,
    #[cfg_attr(
        feature = "cli",
    ...
    pub placement_group_type: Option<
        crate::models::PostApiVersionPlacementGroupsResponsePlacementGroupTypeEnum,
    >,
