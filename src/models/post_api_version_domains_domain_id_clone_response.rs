...
pub struct PostApiVersionDomainsDomainIdCloneResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionDomainsDomainIdCloneResponseStatusEnum,
    >,
    ...
    pub type_field: Option<
        crate::models::PostApiVersionDomainsDomainIdCloneResponseTypeEnum,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
