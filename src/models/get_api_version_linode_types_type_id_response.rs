...
pub struct GetApiVersionLinodeTypesTypeIdResponse {
    #[cfg_attr(feature = "cli", arg(id = "addons", long = "addons"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeTypesTypeIdResponseAddons>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub addons: Option<crate::models::GetApiVersionLinodeTypesTypeIdResponseAddons>,
    #[cfg_attr(feature = "cli", arg(id = "class", long = "class"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub class: Option<crate::models::GetApiVersionLinodeTypesTypeIdResponseClassEnum>,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeTypesTypeIdResponsePrice>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub price: Option<crate::models::GetApiVersionLinodeTypesTypeIdResponsePrice>,
    #[cfg_attr(feature = "cli", arg(id = "region-prices", long = "region-prices"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeTypesTypeIdResponseRegionPricesItem>
        )
    )]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub region_prices: Option<
        Vec<crate::models::GetApiVersionLinodeTypesTypeIdResponseRegionPricesItem>,
    >,
