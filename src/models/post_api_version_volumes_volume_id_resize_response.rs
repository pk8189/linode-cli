...
pub struct PostApiVersionVolumesVolumeIdResizeResponse {
    ...
    pub encryption: Option<
        crate::models::PostApiVersionVolumesVolumeIdResizeResponseEncryptionEnum,
    >,
    ...
    pub hardware_type: Option<
        crate::models::PostApiVersionVolumesVolumeIdResizeResponseHardwareTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionVolumesVolumeIdResizeResponseStatusEnum,
    >,
