...
pub struct PutApiVersionDatabasesPostgresqlInstancesInstanceIdResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionDatabasesPostgresqlInstancesInstanceIdResponseHosts>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub hosts: Option<
        crate::models::PutApiVersionDatabasesPostgresqlInstancesInstanceIdResponseHosts,
    >,
    ...
    pub replication_commit_type: Option<
        crate::models::PutApiVersionDatabasesPostgresqlInstancesInstanceIdResponseReplicationCommitTypeEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "replication-type", long = "replication-type"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub replication_type: Option<
        crate::models::PutApiVersionDatabasesPostgresqlInstancesInstanceIdResponseReplicationTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PutApiVersionDatabasesPostgresqlInstancesInstanceIdResponseStatusEnum,
    >,
    #[cfg_attr(
        feature = "cli",
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionDatabasesPostgresqlInstancesInstanceIdResponseUpdates>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub updates: Option<
        crate::models::PutApiVersionDatabasesPostgresqlInstancesInstanceIdResponseUpdates,
    >,
    #[cfg_attr(
        feature = "cli",
