...
pub struct GetApiVersionImagesResponseDataItem {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionImagesResponseDataItemRegionsItem>
        )
    )]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub regions: Option<
        Vec<crate::models::GetApiVersionImagesResponseDataItemRegionsItem>,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::GetApiVersionImagesResponseDataItemStatusEnum>,
    ...
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_field: Option<crate::models::GetApiVersionImagesResponseDataItemTypeEnum>,
