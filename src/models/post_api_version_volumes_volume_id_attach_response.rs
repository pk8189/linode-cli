...
pub struct PostApiVersionVolumesVolumeIdAttachResponse {
    ...
    pub encryption: Option<
        crate::models::PostApiVersionVolumesVolumeIdAttachResponseEncryptionEnum,
    >,
    ...
    pub hardware_type: Option<
        crate::models::PostApiVersionVolumesVolumeIdAttachResponseHardwareTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionVolumesVolumeIdAttachResponseStatusEnum,
    >,
