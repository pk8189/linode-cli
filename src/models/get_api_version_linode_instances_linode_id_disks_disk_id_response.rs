...
pub struct GetApiVersionLinodeInstancesLinodeIdDisksDiskIdResponse {
    ...
    pub filesystem: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdDisksDiskIdResponseFilesystemEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdDisksDiskIdResponseStatusEnum,
    >,
