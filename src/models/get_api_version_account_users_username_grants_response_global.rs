...
pub struct GetApiVersionAccountUsersUsernameGrantsResponseGlobal {
    #[cfg_attr(feature = "cli", arg(id = "account-access", long = "account-access"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::GetApiVersionAccountUsersUsernameGrantsResponseGlobalAccountAccessEnum>,
    ...
    pub account_access: crate::core::patch::Patch<
        crate::models::GetApiVersionAccountUsersUsernameGrantsResponseGlobalAccountAccessEnum,
    >,
