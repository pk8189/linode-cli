...
pub struct GetApiVersionLkeClustersResponseDataItem {
    #[cfg_attr(feature = "cli", arg(id = "control-plane", long = "control-plane"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLkeClustersResponseDataItemControlPlane>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub control_plane: Option<
        crate::models::GetApiVersionLkeClustersResponseDataItemControlPlane,
    >,
