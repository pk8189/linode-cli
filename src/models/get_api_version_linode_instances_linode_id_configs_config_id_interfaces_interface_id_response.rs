...
pub struct GetApiVersionLinodeInstancesLinodeIdConfigsConfigIdInterfacesInterfaceIdResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeInstancesLinodeIdConfigsConfigIdInterfacesInterfaceIdResponseIpv4>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ipv4: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdConfigsConfigIdInterfacesInterfaceIdResponseIpv4,
    >,
    ...
    pub purpose: crate::models::GetApiVersionLinodeInstancesLinodeIdConfigsConfigIdInterfacesInterfaceIdResponsePurposeEnum,
