...
pub struct PutApiVersionVolumesVolumeIdResponse {
    ...
    pub encryption: Option<
        crate::models::PutApiVersionVolumesVolumeIdResponseEncryptionEnum,
    >,
    ...
    pub hardware_type: Option<
        crate::models::PutApiVersionVolumesVolumeIdResponseHardwareTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::PutApiVersionVolumesVolumeIdResponseStatusEnum>,
