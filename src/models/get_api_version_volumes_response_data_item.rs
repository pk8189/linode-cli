...
pub struct GetApiVersionVolumesResponseDataItem {
    ...
    pub encryption: Option<
        crate::models::GetApiVersionVolumesResponseDataItemEncryptionEnum,
    >,
    ...
    pub hardware_type: Option<
        crate::models::GetApiVersionVolumesResponseDataItemHardwareTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::GetApiVersionVolumesResponseDataItemStatusEnum>,
