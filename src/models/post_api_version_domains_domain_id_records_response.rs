...
pub struct PostApiVersionDomainsDomainIdRecordsResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::PostApiVersionDomainsDomainIdRecordsResponseTagEnum>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub tag: crate::core::patch::Patch<
        crate::models::PostApiVersionDomainsDomainIdRecordsResponseTagEnum,
    >,
    ...
    pub type_field: Option<
        crate::models::PostApiVersionDomainsDomainIdRecordsResponseTypeEnum,
    >,
