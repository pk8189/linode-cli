...
pub struct PostApiVersionDomainsResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::PostApiVersionDomainsResponseStatusEnum>,
    ...
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_field: Option<crate::models::PostApiVersionDomainsResponseTypeEnum>,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
        arg(
