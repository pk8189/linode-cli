...
pub struct PostApiVersionNodebalancersNodeBalancerIdConfigsResponse {
    #[cfg_attr(feature = "cli", arg(id = "algorithm", long = "algorithm"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsResponseAlgorithmEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "check", long = "check"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub check: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsResponseCheckEnum,
    >,
    ...
    pub cipher_suite: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsResponseCipherSuiteEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsResponseNodesStatus>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nodes_status: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsResponseNodesStatus,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub protocol: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsResponseProtocolEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "proxy-protocol", long = "proxy-protocol"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub proxy_protocol: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsResponseProxyProtocolEnum,
    >,
    ...
    pub stickiness: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsResponseStickinessEnum,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
