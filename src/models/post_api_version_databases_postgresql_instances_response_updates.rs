...
pub struct PostApiVersionDatabasesPostgresqlInstancesResponseUpdates {
    ...
    pub frequency: Option<
        crate::models::PostApiVersionDatabasesPostgresqlInstancesResponseUpdatesFrequencyEnum,
    >,
