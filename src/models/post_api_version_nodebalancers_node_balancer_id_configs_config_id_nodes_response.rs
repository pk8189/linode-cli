...
pub struct PostApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mode: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesResponseModeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesResponseStatusEnum,
    >,
