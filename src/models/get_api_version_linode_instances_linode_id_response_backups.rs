...
pub struct GetApiVersionLinodeInstancesLinodeIdResponseBackups {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeInstancesLinodeIdResponseBackupsSchedule>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub schedule: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdResponseBackupsSchedule,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
