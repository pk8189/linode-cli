...
pub struct PutApiVersionDatabasesPostgresqlInstancesInstanceIdResponseUpdates {
    ...
    pub frequency: Option<
        crate::models::PutApiVersionDatabasesPostgresqlInstancesInstanceIdResponseUpdatesFrequencyEnum,
    >,
