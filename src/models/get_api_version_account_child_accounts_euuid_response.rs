...
pub struct GetApiVersionAccountChildAccountsEuuidResponse {
    ...
    pub billing_source: Option<
        crate::models::GetApiVersionAccountChildAccountsEuuidResponseBillingSourceEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionAccountChildAccountsEuuidResponseCreditCard>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub credit_card: Option<
        crate::models::GetApiVersionAccountChildAccountsEuuidResponseCreditCard,
    >,
