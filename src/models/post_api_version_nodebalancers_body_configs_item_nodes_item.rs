...
pub struct PostApiVersionNodebalancersBodyConfigsItemNodesItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mode: Option<
        crate::models::PostApiVersionNodebalancersBodyConfigsItemNodesItemModeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionNodebalancersBodyConfigsItemNodesItemStatusEnum,
    >,
