...
pub struct GetApiVersionSupportTicketsTicketIdResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionSupportTicketsTicketIdResponseEntity>
        )
    )]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::GetApiVersionSupportTicketsTicketIdResponseEntity>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub entity: crate::core::patch::Patch<
        crate::models::GetApiVersionSupportTicketsTicketIdResponseEntity,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionSupportTicketsTicketIdResponseStatusEnum,
    >,
