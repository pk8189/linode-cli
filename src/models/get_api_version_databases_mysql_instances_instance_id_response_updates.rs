...
pub struct GetApiVersionDatabasesMysqlInstancesInstanceIdResponseUpdates {
    ...
    pub frequency: Option<
        crate::models::GetApiVersionDatabasesMysqlInstancesInstanceIdResponseUpdatesFrequencyEnum,
    >,
