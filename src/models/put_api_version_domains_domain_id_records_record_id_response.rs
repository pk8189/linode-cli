...
pub struct PutApiVersionDomainsDomainIdRecordsRecordIdResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::PutApiVersionDomainsDomainIdRecordsRecordIdResponseTagEnum>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub tag: crate::core::patch::Patch<
        crate::models::PutApiVersionDomainsDomainIdRecordsRecordIdResponseTagEnum,
    >,
    ...
    pub type_field: Option<
        crate::models::PutApiVersionDomainsDomainIdRecordsRecordIdResponseTypeEnum,
    >,
