...
pub struct PostApiVersionDatabasesMysqlInstancesResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionDatabasesMysqlInstancesResponseHosts>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub hosts: Option<crate::models::PostApiVersionDatabasesMysqlInstancesResponseHosts>,
    ...
    pub replication_type: Option<
        crate::models::PostApiVersionDatabasesMysqlInstancesResponseReplicationTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionDatabasesMysqlInstancesResponseStatusEnum,
    >,
    #[cfg_attr(
        feature = "cli",
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionDatabasesMysqlInstancesResponseUpdates>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub updates: Option<
        crate::models::PostApiVersionDatabasesMysqlInstancesResponseUpdates,
    >,
    #[cfg_attr(
        feature = "cli",
