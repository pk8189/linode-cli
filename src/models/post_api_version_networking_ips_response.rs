...
pub struct PostApiVersionNetworkingIpsResponse {
    ...
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_field: Option<crate::models::PostApiVersionNetworkingIpsResponseTypeEnum>,
    #[cfg_attr(feature = "cli", arg(id = "vpc-nat-1-1", long = "vpc-nat-1-1"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PostApiVersionNetworkingIpsResponseVpcNat11>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub vpc_nat_1_1: Option<crate::models::PostApiVersionNetworkingIpsResponseVpcNat11>,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
        arg(
