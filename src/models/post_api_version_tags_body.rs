...
pub struct PostApiVersionTagsBody {
    ...
    #[cfg_attr(feature = "cli", arg(id = "nodebalancers", long = "nodebalancers"))]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nodebalancers: Option<Vec<i64>>,
    #[cfg_attr(feature = "cli", arg(id = "volumes", long = "volumes"))]
    #[cfg_attr(feature = "cli", arg(num_args = 0.., value_delimiter = ' '))]
    #[serde(skip_serializing_if = "Option::is_none")]
