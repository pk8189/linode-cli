...
pub struct GetApiVersionTagsTagLabelResponseDataItemDataObj0 {
    #[cfg_attr(feature = "cli", arg(id = "alerts", long = "alerts"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0Alerts>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alerts: Option<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0Alerts,
    >,
    #[cfg_attr(feature = "cli", arg(id = "backups", long = "backups"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0Backups>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub backups: Option<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0Backups,
    >,
    ...
    pub hypervisor: Option<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0HypervisorEnum,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0PlacementGroup>
        )
    )]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0PlacementGroup>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub placement_group: crate::core::patch::Patch<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0PlacementGroup,
    >,
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0Specs>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub specs: Option<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0Specs,
    >,
    #[cfg_attr(feature = "cli", arg(id = "status", long = "status"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionTagsTagLabelResponseDataItemDataObj0StatusEnum,
    >,
