...
pub struct PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesNodeIdBody {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mode: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesNodeIdBodyModeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PutApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesNodeIdBodyStatusEnum,
    >,
