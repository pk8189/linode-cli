...
pub struct GetApiVersionDomainsDomainIdResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::GetApiVersionDomainsDomainIdResponseStatusEnum>,
    ...
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_field: Option<crate::models::GetApiVersionDomainsDomainIdResponseTypeEnum>,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
        arg(
