...
pub struct PutApiVersionDatabasesMysqlInstancesInstanceIdResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionDatabasesMysqlInstancesInstanceIdResponseHosts>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub hosts: Option<
        crate::models::PutApiVersionDatabasesMysqlInstancesInstanceIdResponseHosts,
    >,
    ...
    pub replication_type: Option<
        crate::models::PutApiVersionDatabasesMysqlInstancesInstanceIdResponseReplicationTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PutApiVersionDatabasesMysqlInstancesInstanceIdResponseStatusEnum,
    >,
    #[cfg_attr(
        feature = "cli",
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionDatabasesMysqlInstancesInstanceIdResponseUpdates>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub updates: Option<
        crate::models::PutApiVersionDatabasesMysqlInstancesInstanceIdResponseUpdates,
    >,
    #[cfg_attr(
        feature = "cli",
