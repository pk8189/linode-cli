...
pub struct PostApiVersionDomainsDomainIdRecordsBody {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::PostApiVersionDomainsDomainIdRecordsBodyTagEnum>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub tag: crate::core::patch::Patch<
        crate::models::PostApiVersionDomainsDomainIdRecordsBodyTagEnum,
    >,
    ...
    pub type_field: Option<
        crate::models::PostApiVersionDomainsDomainIdRecordsBodyTypeEnum,
    >,
