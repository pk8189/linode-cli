...
pub struct GetApiVersionDatabasesMysqlInstancesInstanceIdResponse {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionDatabasesMysqlInstancesInstanceIdResponseHosts>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub hosts: Option<
        crate::models::GetApiVersionDatabasesMysqlInstancesInstanceIdResponseHosts,
    >,
    ...
    pub replication_type: Option<
        crate::models::GetApiVersionDatabasesMysqlInstancesInstanceIdResponseReplicationTypeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::GetApiVersionDatabasesMysqlInstancesInstanceIdResponseStatusEnum,
    >,
    #[cfg_attr(
        feature = "cli",
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionDatabasesMysqlInstancesInstanceIdResponseUpdates>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub updates: Option<
        crate::models::GetApiVersionDatabasesMysqlInstancesInstanceIdResponseUpdates,
    >,
    #[cfg_attr(
        feature = "cli",
