...
pub struct PostApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesBody {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mode: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesBodyModeEnum,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        crate::models::PostApiVersionNodebalancersNodeBalancerIdConfigsConfigIdNodesBodyStatusEnum,
    >,
