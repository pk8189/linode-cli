...
pub struct PutApiVersionDomainsDomainIdRecordsRecordIdBody {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_patch::<crate::models::PutApiVersionDomainsDomainIdRecordsRecordIdBodyTagEnum>,
            default_value = "___undefined___"
        )
    )]
    #[serde(default)]
    ...
    pub tag: crate::core::patch::Patch<
        crate::models::PutApiVersionDomainsDomainIdRecordsRecordIdBodyTagEnum,
    >,
