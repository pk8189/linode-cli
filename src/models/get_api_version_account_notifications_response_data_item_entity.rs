...
pub struct GetApiVersionAccountNotificationsResponseDataItemEntity {
    ...
    pub id: crate::core::patch::Patch<i64>,
    ...
    pub type_field: Option<
        crate::models::GetApiVersionAccountNotificationsResponseDataItemEntityTypeEnum,
    >,
    ...
    #[serde(default)]
    #[serde(skip_serializing_if = "crate::core::patch::Patch::is_undefined")]
    pub url: crate::core::patch::Patch<String>,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
        arg(
