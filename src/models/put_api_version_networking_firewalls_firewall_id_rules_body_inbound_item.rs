...
pub struct PutApiVersionNetworkingFirewallsFirewallIdRulesBodyInboundItem {
    #[cfg_attr(feature = "cli", arg(id = "action", long = "action"))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub action: Option<
        crate::models::PutApiVersionNetworkingFirewallsFirewallIdRulesBodyInboundItemActionEnum,
    >,
    #[cfg_attr(feature = "cli", arg(id = "addresses", long = "addresses"))]
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::PutApiVersionNetworkingFirewallsFirewallIdRulesBodyInboundItemAddresses>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub addresses: Option<
        crate::models::PutApiVersionNetworkingFirewallsFirewallIdRulesBodyInboundItemAddresses,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub protocol: Option<
        crate::models::PutApiVersionNetworkingFirewallsFirewallIdRulesBodyInboundItemProtocolEnum,
    >,
    #[serde(flatten)]
    #[cfg_attr(
        feature = "cli",
