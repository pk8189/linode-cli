...
pub struct GetApiVersionLinodeInstancesLinodeIdConfigsConfigIdResponseInterfacesItem {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(
            value_parser = crate::core::clap::parse_json::<crate::models::GetApiVersionLinodeInstancesLinodeIdConfigsConfigIdResponseInterfacesItemIpv4>
        )
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ipv4: Option<
        crate::models::GetApiVersionLinodeInstancesLinodeIdConfigsConfigIdResponseInterfacesItemIpv4,
    >,
    ...
    pub purpose: crate::models::GetApiVersionLinodeInstancesLinodeIdConfigsConfigIdResponseInterfacesItemPurposeEnum,
