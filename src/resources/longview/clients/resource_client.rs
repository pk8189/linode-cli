...
impl ClientsClient {
    ...
    pub async fn delete(
        ...
        let url = self
            ...
            .build_url(
                &format!(
                    "/{}/longview/clients/{}", & request.api_version, & request.client_id
                ),
            );
    ...
    pub async fn list(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionLongviewClientsResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/longview/clients", & request.api_version));
        ...
        crate::core::response::process_json::<
            crate::models::GetApiVersionLongviewClientsResponse,
        >(response)
            .await
    }
    ...
    pub async fn get(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionLongviewClientsClientIdResponse> {
        let url = self
            .base_client
            .build_url(
                &format!(
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::GetApiVersionLongviewClientsClientIdResponse,
        >(response)
            .await
    }
    ...
    pub async fn create(
    ...
    ) -> crate::SdkResult<crate::models::PostApiVersionLongviewClientsResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/longview/clients", & request.api_version));
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::PostApiVersionLongviewClientsResponse,
        >(response)
            .await
    }
    ...
    pub async fn put(
    ...
    ) -> crate::SdkResult<crate::models::PutApiVersionLongviewClientsClientIdResponse> {
        let url = self
            .base_client
            .build_url(
                &format!(
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::PutApiVersionLongviewClientsClientIdResponse,
        >(response)
            .await
    }
}
