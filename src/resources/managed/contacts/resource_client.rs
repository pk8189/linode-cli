...
impl ContactsClient {
    ...
    pub async fn delete(
        ...
        let url = self
            ...
            .build_url(
                &format!(
                    "/{}/managed/contacts/{}", & request.api_version, & request
                    .contact_id
                ),
            );
    ...
    pub async fn list(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionManagedContactsResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/managed/contacts", & request.api_version));
        ...
        crate::core::response::process_json::<
            crate::models::GetApiVersionManagedContactsResponse,
        >(response)
            .await
    }
    ...
    pub async fn get(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionManagedContactsContactIdResponse> {
        let url = self
            .base_client
            .build_url(
                &format!(
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::GetApiVersionManagedContactsContactIdResponse,
        >(response)
            .await
    }
    ...
    pub async fn create(
    ...
    ) -> crate::SdkResult<crate::models::PostApiVersionManagedContactsResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/managed/contacts", & request.api_version));
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::PostApiVersionManagedContactsResponse,
        >(response)
            .await
    }
    ...
    pub async fn put(
    ...
    ) -> crate::SdkResult<crate::models::PutApiVersionManagedContactsContactIdResponse> {
        let url = self
            .base_client
            .build_url(
                &format!(
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::PutApiVersionManagedContactsContactIdResponse,
        >(response)
            .await
    }
}
