...
impl IssuesClient {
    ...
    pub async fn list(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionManagedIssuesResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/managed/issues", & request.api_version));
        ...
        crate::core::response::process_json::<
            crate::models::GetApiVersionManagedIssuesResponse,
        >(response)
            .await
    }
    ...
    pub async fn get(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionManagedIssuesIssueIdResponse> {
        let url = self
            .base_client
            .build_url(
                &format!(
                    "/{}/managed/issues/{}", & request.api_version, & request.issue_id
                ),
            );
        let mut builder = reqwest::Client::default().get(&url);
        builder = builder.header("x-sideko-sdk-language", "rust");
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::GetApiVersionManagedIssuesIssueIdResponse,
        >(response)
            .await
    }
}
