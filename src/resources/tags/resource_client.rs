...
impl TagsClient {
    ...
    pub async fn delete(
        ...
        let url = self
            .base_client
            .build_url(
                &format!("/{}/tags/{}", & request.api_version, & request.tag_label),
            );
    ...
    pub async fn list(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionTagsResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/tags", & request.api_version));
        ...
        crate::core::response::process_json::<
            crate::models::GetApiVersionTagsResponse,
        >(response)
            .await
    }
    ...
    pub async fn get(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionTagsTagLabelResponse> {
        let url = self
            .base_client
            .build_url(
                &format!("/{}/tags/{}", & request.api_version, & request.tag_label),
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::GetApiVersionTagsTagLabelResponse,
        >(response)
            .await
    }
    ...
    pub async fn create(
    ...
    ) -> crate::SdkResult<crate::models::PostApiVersionTagsResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/tags", & request.api_version));
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::PostApiVersionTagsResponse,
        >(response)
            .await
    }
}
