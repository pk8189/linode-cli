...
impl BackupsClient {
    ...
    pub fn restore(
        &self,
    ) -> crate::resources::databases::mysql::instances::backups::restore::resource_client::RestoreClient {
        crate::resources::databases::mysql::instances::backups::restore::resource_client::RestoreClient::new(
    ...
    pub async fn delete(
        ...
        let url = self
            ...
            .build_url(
                &format!(
                    "/{}/databases/mysql/instances/{}/backups/{}", & request.api_version,
                    & request.instance_id, & request.backup_id
                ),
            );
    ...
    pub async fn get(
        ...
        crate::models::GetApiVersionDatabasesMysqlInstancesInstanceIdBackupsBackupIdResponse,
    > {
        let url = self
            .base_client
            .build_url(
