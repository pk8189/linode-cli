...
impl CredentialsClient {
    ...
    pub fn reset(
        &self,
    ) -> crate::resources::databases::postgresql::instances::credentials::reset::resource_client::ResetClient {
        crate::resources::databases::postgresql::instances::credentials::reset::resource_client::ResetClient::new(
    ...
    pub async fn list(
        ...
        crate::models::GetApiVersionDatabasesPostgresqlInstancesInstanceIdCredentialsResponse,
    > {
        let url = self
            .base_client
            .build_url(
                &format!(
                    "/{}/databases/postgresql/instances/{}/credentials", & request
