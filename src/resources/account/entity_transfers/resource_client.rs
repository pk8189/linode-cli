#[derive(Clone, Debug)]
pub struct EntityTransfersClient {
    base_client: crate::core::base_client::BaseClient,
}
impl EntityTransfersClient {
    pub(crate) fn new(base_client: crate::core::base_client::BaseClient) -> Self {
        Self { base_client }
    }
    pub fn accept(
        &self,
    ) -> crate::resources::account::entity_transfers::accept::resource_client::AcceptClient {
        crate::resources::account::entity_transfers::accept::resource_client::AcceptClient::new(
    ...
    pub async fn delete(
        ...
        let url = self
            ...
            .build_url(
                &format!(
                    "/{}/account/entity-transfers/{}", & request.api_version, & request
                    .token
                ),
            );
    ...
    pub async fn list(
        ...
        let url = self
            .base_client
            .build_url(&format!("/{}/account/entity-transfers", & request.api_version));
    ...
    pub async fn get(
        ...
        crate::models::GetApiVersionAccountEntityTransfersTokenResponse,
    > {
        let url = self
            .base_client
            .build_url(
    ...
    pub async fn create(
    ...
    ) -> crate::SdkResult<crate::models::PostApiVersionAccountEntityTransfersResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/account/entity-transfers", & request.api_version));
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::PostApiVersionAccountEntityTransfersResponse,
        >(response)
            .await
    }
}
