...
impl TokensClient {
    ...
    pub async fn delete(
        ...
        let url = self
            ...
            .build_url(
                &format!(
                    "/{}/profile/tokens/{}", & request.api_version, & request.token_id
                ),
            );
    ...
    pub async fn list(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionProfileTokensResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/profile/tokens", & request.api_version));
        ...
        crate::core::response::process_json::<
            crate::models::GetApiVersionProfileTokensResponse,
        >(response)
            .await
    }
    ...
    pub async fn get(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionProfileTokensTokenIdResponse> {
        let url = self
            .base_client
            .build_url(
                &format!(
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::GetApiVersionProfileTokensTokenIdResponse,
        >(response)
            .await
    }
    ...
    pub async fn create(
    ...
    ) -> crate::SdkResult<crate::models::PostApiVersionProfileTokensResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/profile/tokens", & request.api_version));
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::PostApiVersionProfileTokensResponse,
        >(response)
            .await
    }
    ...
    pub async fn put(
    ...
    ) -> crate::SdkResult<crate::models::PutApiVersionProfileTokensTokenIdResponse> {
        let url = self
            .base_client
            .build_url(
                &format!(
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::PutApiVersionProfileTokensTokenIdResponse,
        >(response)
            .await
    }
}
