...
impl DevicesClient {
    ...
    pub async fn delete(
        ...
        let url = self
            ...
            .build_url(
                &format!(
                    "/{}/profile/devices/{}", & request.api_version, & request.device_id
                ),
            );
    ...
    pub async fn list(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionProfileDevicesResponse> {
        let url = self
            .base_client
            .build_url(&format!("/{}/profile/devices", & request.api_version));
        ...
        crate::core::response::process_json::<
            crate::models::GetApiVersionProfileDevicesResponse,
        >(response)
            .await
    }
    ...
    pub async fn get(
    ...
    ) -> crate::SdkResult<crate::models::GetApiVersionProfileDevicesDeviceIdResponse> {
        let url = self
            .base_client
            .build_url(
                &format!(
        ...
        response = self.base_client.error_for_status(response).await?;
        crate::core::response::process_json::<
            crate::models::GetApiVersionProfileDevicesDeviceIdResponse,
        >(response)
            .await
    }
}
